...
def _apply_op(
    ...
    if op_name == "ShearX":
        img = F.affine(
            ...
            translate=[0, 0],
            scale=1.0,
            shear=[16.7*magnitude,0.],   # Corresponds to arctan(0.3)
        ...
        img = F.affine(
            img,
            angle=0.0,
            translate=[int(150/331*magnitude*img.size[1]), 0],
            scale=1.0,
            interpolation=interpolation,
            shear=[0.0, 0.0],
            fill=fill,
        ...
        img = F.affine(
            img,
            angle=0.0,
            translate=[0,int(150/331*magnitude*img.size[0])],
            scale=1.0,
            interpolation=interpolation,
            shear=[0.0, 0.0],
            fill=fill,
        ...
        img = F.rotate(img, magnitude*30, interpolation=interpolation, fill=fill)
        ...
        img = Image.blend(img,F.equalize(img),magnitude) 
